        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="page-title-wrapper text-center">
                    <h1 class="page-title">We are a textile conglomerate striving continuously creating value in all aspects of
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-xxl-10">
                <div class="visiblityClass section_title_wrapper text-center mb-50 wow fadeInUp" data-wow-delay="0.3s" >                      
    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-6 col-lg-6 p-relative mb-30">
                <div class="visiblityClass section_title_wrapper mb-25 wow fadeInUp" data-wow-delay="0.3s" >                   
                    <h2 class="msection-title msection-title-white">
                        Happy Customer Says <br/> About  <span> Mega</span>
                    </h2>
                </div>
                <div class="visiblityClass client-active swiper-container wow fadeInUp" data-wow-delay="0.6s">
                ...
                <div class="visiblityClass tp-testimonial-slider-arrow service-single-arrow wow fadeInUp" data-wow-delay="0.6s">
            ...
            <div class="col-xl-6 col-lg-6">
                <div class="achievement-group ml-100">
                    <div class="visiblityClass achievement-item ar-border mb-30 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <div class="visiblityClass achievement-item ar-border mb-30 wow fadeInUp" data-wow-delay="0.6s" >
                        <ul class="achievement-item-box d-flex align-items-center">
                    ...
                    <div class="visiblityClass achievement-item ar-border wow fadeInUp" data-wow-delay="0.9s"   >
                        <ul class="achievement-item-box d-flex align-items-center">
